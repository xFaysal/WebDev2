...
$cityId = "2643123"; //5046997 Shakopee City Id
...
<body class="manchester">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="images/manteam.jpg" width="100%">
            </div>
            <div class="col-sm-6">
...
<p class="manchesters">They are Sponsored by Etihad Airways</p>
