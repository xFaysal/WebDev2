...
$cityId = "2644210"; //5046997 Shakopee City Id
...
<body class="liverpool">
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav">
                    ...
                    <a href="liverpool.php" class="nav-item nav-link active">Liverpool F.C.</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="images/lpteam.jpg" width="100%">
            </div>
            <div class="col-sm-6">
...
<p class="liverpools">They are Sponsored by Standard Chartered</p>
