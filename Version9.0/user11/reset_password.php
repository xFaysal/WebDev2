...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="navbar-nav ml-auto">
                    <a href="reset_password.php" class="nav-item nav-link active" tabindex="-1">Reset password</a>
    ...
    <div class="wrapper">
        ...
        <p class="paragraph">Please fill out this form to reset your password.</p>
