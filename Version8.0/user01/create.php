...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($input_address)){
        $address_err = "Please enter your base coords.";     
    } else{
    ...
    if(empty($input_salary)){
        $salary_err = "Please enter your diamond amount.";     
...
<head>
    <meta charset="UTF-8">
    <title>Brandon's Server - Create Player Data</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <a href="index_crud.php" class="btn btn-default">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
